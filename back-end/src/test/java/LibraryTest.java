...
public class LibraryTest {
    ...
    public void bookRegisterTest() {
       ...
       // BookQueryConditions conditions1=new BookQueryConditions();
        //conditions1.setCategory("Others");
       // ApiResult queryResult = library.queryBook(conditions1);
        ...
        System.out.println( selectedResults.getCount());
         // for (int i = 0; i < compareBooks.size(); i++) {
           // System.out.println(selectedResults.getResults().get(i).toString()) ;
        //}
        ...
        for (int i = 0; i < 1000; i++) {
            if (RandomUtils.nextBoolean() && borrowList.size() > 0) { // do return book
                ...
                if (borrowStatus.contains(sp) || stockMap.get(r.getBookId()) == 0) {
                    ...
                    if(borrowStatus.contains(sp)) {
                        //System.out.println ("1");
                    }
                    if(stockMap.get(r.getBookId()) == 0){
...
//        for(int i=0;i<my.cards.size();i++){
//            System.out.println (my.cards.get(i).toString());
//        }
//        System.out.println("11111111");
      ...
      //  for(int i=0;i<resCardList.getCards().size();i++){
          //  System.out.println (resCardList.getCards().get(i).toString());
      //  }
        /* duplicate create */
